...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates Channel 🔔', url='https://t.me/MovizBotUpdate')
            ],
            [
                InlineKeyboardButton('📷 Movie/Series Request Group 📷', url=f"https://t.me/MovizRequestGroup"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔔 BOT Updates Channel 🔔', url=f"https://t.me/MovizBotUpdate"),
            InlineKeyboardButton('📷 Movie/Series Request Group 📷', url='https://t.me/MovizRequestGroup')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ YouTube', url='https://www.youtube.com/@bliZZardOP')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
